...
class NoteInput extends React.Component {
  constructor(props) {
    ...
    this.state = {
      // TODO [Basic] kelola nilai title sebagai controlled input.✔️
      title: "",
      // TODO [Basic] kelola nilai body sebagai controlled textarea.✔️
      body: "",
    };
  ...
  onTitleChangeEventHandler(event) {
    // TODO [Basic] update state dengan nilai event.target.value.✔️
  ...
  onBodyChangeEventHandler(event) {
    // TODO [Basic] update state body agar textarea menjadi controlled component.✔️
    this.setState(() => {
      return {
  ...
  onSubmitEventHandler(event) {
    ...
    // TODO [Basic] panggil props.addNote dengan data title & body dari state, lalu reset form.✔️
    ...
    return (
      <div className="note-input" data-testid="note-input">
        ...
        {this.state.bodyError && (
          <p className="note-input__feedback--error">Body minimal 10 karakter.</p>
        )}
        ...
        >
          ...
          <p
            ...
            style={{ color: remainingChars <= 10 ? "yellow" : "inherit" }}
          >
